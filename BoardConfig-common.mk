...
# Keep the system partition filesystem type explicit for dumpvars/image setup,
# but allow product makefiles to provide the same default earlier during parsing.
